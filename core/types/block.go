...
func (b *Block) MarshalJSON() ([]byte, error) {
	...
	extra := b.Extra()
	enc.Extra = (*hexutil.Bytes)(&extra)
	gasLimit := b.GasLimit()
	enc.GasLimit = (*hexutil.Uint64)(&gasLimit)
	gasUsed := b.GasUsed()
	enc.GasUsed = (*hexutil.Uint64)(&gasUsed)
	enc.Bloom = b.Bloom()
	enc.Miner = b.Coinbase()
	enc.MixDigest = b.MixDigest()
	enc.Nonce = b.Nonce()
	enc.Number = (*hexutil.Big)(b.Number())
	enc.ParentHash = b.ParentHash()
	enc.ReceiptHash = b.ReceiptHash()
	enc.Sha3Uncles = b.UncleHash()
	enc.Root = b.Root()
	t := b.Time()
	enc.Time = (*hexutil.Uint64)(&t)
	enc.TxHash = b.TxHash()
...
func (b *Block) UnmarshalJSON(data []byte) error {
	...
	b.header = &Header{
		...
		UncleHash:   blockJSON.Sha3Uncles,
		Coinbase:    blockJSON.Miner,
		Root:        blockJSON.Root,
		TxHash:      blockJSON.TxHash,
		ReceiptHash: blockJSON.ReceiptHash,
		Bloom:       blockJSON.Bloom,
		Difficulty:  blockJSON.Difficulty.ToInt(),
		Number:      blockJSON.Number.ToInt(),
		GasLimit:    uint64(*blockJSON.GasLimit),
		GasUsed:     uint64(*blockJSON.GasUsed),
		Time:        uint64(*blockJSON.Time),
		Extra:       ([]byte)(*blockJSON.Extra),
		MixDigest:   blockJSON.MixDigest,
		Nonce:       blockJSON.Nonce,
		BaseFee:     blockJSON.BaseFee.ToInt(),
	}
